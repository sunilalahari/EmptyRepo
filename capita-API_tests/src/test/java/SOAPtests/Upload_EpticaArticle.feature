...
Scenario: Upload SourceSystem Articles 
	...
	* def TryGetByMetadataSearch = read('../data/TryGetByMetadataSearch_EpticaArticle.xml')
	...
	* print TryGetByMetadataSearch
	...
	Given request read('../data/TryGetByMetadataSearch_EpticaArticle.xml')
	...
	* def TryGetByMetadataSearch = read('../data/TryGetByMetadataSearch_EpticaArticle_expected.xml')
	...
	* set TryGetByMetadataSearch/Envelope/Header/TFL-SourceSystem = contract
	And match response == read('../data/TryGetByMetadataSearch_EpticaArticle_expected.xml')
	And print response
...
Scenario: Upload SourceSystem Amdocs with repository Knowledge Base
	...
	* set corrospondenceid/Envelope/Body/Upload/sourceSystem = sourcesystem
	...
	And match response /Envelope/Body/Fault/detail contains 'Message: Source System Not Exist: Amdocs Repository Knowledge Base Event ID'
...
Scenario: Upload SourceSystem DAR Material with repository Business Operations
	...
	* set corrospondenceid/Envelope/Body/Upload/sourceSystem = sourcesystem
	...
	And match response /Envelope/Body/Fault/detail contains 'Message: Content Type Name Not Exist in Source System: DAR Material Event ID'
